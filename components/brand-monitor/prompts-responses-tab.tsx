        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
            />
            <svg 
          ...
          <div
            ...
            className={`
              ...
              ${isExpanded 
                ...
                : 'border-gray-200 bg-white hover:border-emerald-100 hover:shadow-sm'
              }
            `}
          >
