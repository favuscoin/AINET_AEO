  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 rounded-[30px] p-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              {/* Pro - Featured */}
              <div className="bg-white p-8 rounded-[20px] border-2 border-emerald-500 relative animate-fade-in-up animation-delay-600 hover:scale-105 transition-all duration-200">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-[30px] p-16 text-center">
